...
class Gsc(BaseModel):
    ...
    gender = pw.CharField()
    year_of_birth = pw.IntegerField(null=True)
    height = pw.CharField(null=True)
    languages = pw.TextField(null=True)
    ...
    church_background = pw.TextField(null=True)
